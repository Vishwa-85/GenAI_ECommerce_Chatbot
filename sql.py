...
def sql_chain(question):
    ...
    if len(matches) == 0:
        return "LLM is not able to generate query for this question"
    
    print("SQL Query:", matches[0].strip())
    response = run_query(matches[0].strip())
    if response is None:
        return "Sorry, there was a problem executing this query"
...
if __name__ == '__main__':
    question = "All Adidas shoes in the price range 5000 to 8000 in the descending order of price"
